...
public class FlowTextLayouts extends ViewGroup {
    ...
    public FlowTextLayouts(Context context) {
        this(context, null);
    }

    public FlowTextLayouts(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowTextLayouts(Context context, AttributeSet attrs, int defStyleAttr) {
